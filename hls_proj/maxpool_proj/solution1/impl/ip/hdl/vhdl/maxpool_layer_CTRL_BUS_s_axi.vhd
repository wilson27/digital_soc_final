...
entity maxpool_layer_CTRL_BUS_s_axi is
generic (
...
end entity maxpool_layer_CTRL_BUS_s_axi;
...
architecture behave of maxpool_layer_CTRL_BUS_s_axi is
    ...
    constant ADDR_INPUT_OFFSET_DATA_0  : INTEGER := 16#10#;
    constant ADDR_INPUT_OFFSET_CTRL    : INTEGER := 16#14#;
    constant ADDR_OUTPUT_OFFSET_DATA_0 : INTEGER := 16#18#;
    constant ADDR_OUTPUT_OFFSET_CTRL   : INTEGER := 16#1c#;
    constant ADDR_B_DATA_0             : INTEGER := 16#20#;
    constant ADDR_B_CTRL               : INTEGER := 16#24#;
    constant ADDR_OD_DATA_0            : INTEGER := 16#28#;
    constant ADDR_OD_CTRL              : INTEGER := 16#2c#;
    constant ADDR_OX_DATA_0            : INTEGER := 16#30#;
    constant ADDR_OX_CTRL              : INTEGER := 16#34#;
    constant ADDR_OY_DATA_0            : INTEGER := 16#38#;
    constant ADDR_OY_CTRL              : INTEGER := 16#3c#;
    constant ADDR_ID_DATA_0            : INTEGER := 16#40#;
    constant ADDR_ID_CTRL              : INTEGER := 16#44#;
    constant ADDR_IX_DATA_0            : INTEGER := 16#48#;
    constant ADDR_IX_CTRL              : INTEGER := 16#4c#;
    constant ADDR_IY_DATA_0            : INTEGER := 16#50#;
    constant ADDR_IY_CTRL              : INTEGER := 16#54#;
    constant ADDR_S_DATA_0             : INTEGER := 16#58#;
    constant ADDR_S_CTRL               : INTEGER := 16#5c#;
    constant ADDR_K_DATA_0             : INTEGER := 16#60#;
    constant ADDR_K_CTRL               : INTEGER := 16#64#;
    ...
    signal int_od              : UNSIGNED(31 downto 0) := (others => '0');
    signal int_ox              : UNSIGNED(31 downto 0) := (others => '0');
    signal int_oy              : UNSIGNED(31 downto 0) := (others => '0');
    signal int_id              : UNSIGNED(31 downto 0) := (others => '0');
    signal int_ix              : UNSIGNED(31 downto 0) := (others => '0');
    signal int_iy              : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OD_DATA_0 =>
                        rdata_data <= RESIZE(int_od(31 downto 0), 32);
                    when ADDR_OX_DATA_0 =>
                        rdata_data <= RESIZE(int_ox(31 downto 0), 32);
                    when ADDR_OY_DATA_0 =>
                        rdata_data <= RESIZE(int_oy(31 downto 0), 32);
                    when ADDR_ID_DATA_0 =>
                        rdata_data <= RESIZE(int_id(31 downto 0), 32);
                    when ADDR_IX_DATA_0 =>
                        rdata_data <= RESIZE(int_ix(31 downto 0), 32);
                    when ADDR_IY_DATA_0 =>
                        rdata_data <= RESIZE(int_iy(31 downto 0), 32);
                    when ADDR_S_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    od                   <= STD_LOGIC_VECTOR(int_od);
    ox                   <= STD_LOGIC_VECTOR(int_ox);
    oy                   <= STD_LOGIC_VECTOR(int_oy);
    id                   <= STD_LOGIC_VECTOR(int_id);
    ix                   <= STD_LOGIC_VECTOR(int_ix);
    iy                   <= STD_LOGIC_VECTOR(int_iy);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OD_DATA_0) then
                    int_od(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_od(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OX_DATA_0) then
                    int_ox(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ox(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OY_DATA_0) then
                    int_oy(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_oy(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IX_DATA_0) then
                    int_ix(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ix(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IY_DATA_0) then
                    int_iy(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_iy(31 downto 0));
                end if;
            end if;
        end if;
    end process;
