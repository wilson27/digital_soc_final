...
#ifndef __maxpool_layer_fcmbkb__HH__
#define __maxpool_layer_fcmbkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxpool_layer_fcmbkb) {
    ...
    SC_CTOR(maxpool_layer_fcmbkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
