...
#ifndef __maxpool_layer_mulhbi__HH__
#define __maxpool_layer_mulhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxpool_layer_mulhbi) {
    ...
    SC_CTOR(maxpool_layer_mulhbi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
