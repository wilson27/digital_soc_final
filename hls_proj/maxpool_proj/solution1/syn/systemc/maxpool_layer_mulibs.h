...
#ifndef __maxpool_layer_mulibs__HH__
#define __maxpool_layer_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxpool_layer_mulibs) {
    ...
    SC_CTOR(maxpool_layer_mulibs):  ACMP_mul_us_U ("ACMP_mul_us_U") {
