...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 22 \
			corename maxpool_layer_CTRL_BUS_axilite \
			name maxpool_layer_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxpool_layer_CTRL_BUS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxpool_layer_mem_m_axi
}
