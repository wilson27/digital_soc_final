...
#ifndef __conv_layer_mul_32hbi__HH__
#define __conv_layer_mul_32hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_mul_32hbi) {
    ...
    SC_CTOR(conv_layer_mul_32hbi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
