; ModuleID = 'C:/Users/Wilson/Desktop/classic_cnn/hls_proj/conv_proj/solution1/.autopilot/db/a.g.1.bc'
...
define void @conv_layer(float* %mem, i32 %input_offset, i32 %output_offset, i32 %b, i32 %od, i32 %ox, i32 %oy, i32 %id, i32 %ix, i32 %iy, i32 %s, i32 %k) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{float* %mem}, i64 0, metadata !2663), !dbg !2664 ; [debug line = 6:25] [debug variable = mem]
  call void @llvm.dbg.value(metadata !{i32 %input_offset}, i64 0, metadata !2665), !dbg !2666 ; [debug line = 7:21] [debug variable = input_offset]
  call void @llvm.dbg.value(metadata !{i32 %output_offset}, i64 0, metadata !2667), !dbg !2668 ; [debug line = 8:21] [debug variable = output_offset]
  call void @llvm.dbg.value(metadata !{i32 %b}, i64 0, metadata !2669), !dbg !2670 ; [debug line = 9:27] [debug variable = b]
  call void @llvm.dbg.value(metadata !{i32 %od}, i64 0, metadata !2671), !dbg !2672 ; [debug line = 10:27] [debug variable = od]
  call void @llvm.dbg.value(metadata !{i32 %ox}, i64 0, metadata !2673), !dbg !2674 ; [debug line = 11:27] [debug variable = ox]
  call void @llvm.dbg.value(metadata !{i32 %oy}, i64 0, metadata !2675), !dbg !2676 ; [debug line = 12:27] [debug variable = oy]
  call void @llvm.dbg.value(metadata !{i32 %id}, i64 0, metadata !2677), !dbg !2678 ; [debug line = 13:27] [debug variable = id]
  call void @llvm.dbg.value(metadata !{i32 %ix}, i64 0, metadata !2679), !dbg !2680 ; [debug line = 14:27] [debug variable = ix]
  call void @llvm.dbg.value(metadata !{i32 %iy}, i64 0, metadata !2681), !dbg !2682 ; [debug line = 15:27] [debug variable = iy]
  call void @llvm.dbg.value(metadata !{i32 %s}, i64 0, metadata !2683), !dbg !2684 ; [debug line = 16:27] [debug variable = s]
  call void @llvm.dbg.value(metadata !{i32 %k}, i64 0, metadata !2685), !dbg !2686 ; [debug line = 17:27] [debug variable = k]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %b, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2689 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %od, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2690 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ox, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2691 ; [debug line = 25:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %oy, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2692 ; [debug line = 26:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %id, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2693 ; [debug line = 27:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ix, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2694 ; [debug line = 28:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %iy, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2695 ; [debug line = 29:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %s, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2696 ; [debug line = 30:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %k, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2697 ; [debug line = 31:1]
  ...
  %tmp = mul i32 %id, %od, !dbg !2701             ; [#uses=1 type=i32] [debug line = 37:29]
  %tmp.1 = mul i32 %tmp, %k, !dbg !2701           ; [#uses=1 type=i32] [debug line = 37:29]
  %num_weights = mul i32 %tmp.1, %k, !dbg !2701   ; [#uses=2 type=i32] [debug line = 37:29]
  call void @llvm.dbg.value(metadata !{i32 %num_weights}, i64 0, metadata !2702), !dbg !2701 ; [debug line = 37:29] [debug variable = num_weights]
  call void @llvm.dbg.value(metadata !{i32 %od}, i64 0, metadata !2703), !dbg !2704 ; [debug line = 38:22] [debug variable = num_biases]
  %tmp.2 = lshr i32 %input_offset, 2, !dbg !2705  ; [#uses=3 type=i32] [debug line = 55:86]
  %tmp.3 = lshr i32 %output_offset, 2, !dbg !2714 ; [#uses=1 type=i32] [debug line = 82:4]
  br label %1, !dbg !2715                         ; [debug line = 43:16]

; <label>:1                                       ; preds = %16, %0
  %b_ = phi i32 [ 0, %0 ], [ %b_.1, %16 ]         ; [#uses=4 type=i32]
  %tmp.4 = icmp slt i32 %b_, %b, !dbg !2715       ; [#uses=1 type=i1] [debug line = 43:16]
  br i1 %tmp.4, label %.preheader2.preheader, label %17, !dbg !2715 ; [debug line = 43:16]

.preheader2.preheader:                            ; preds = %1
  %tmp.5 = mul i32 %b_, %id, !dbg !2716           ; [#uses=1 type=i32] [debug line = 69:120]
  %tmp.6 = mul i32 %b_, %od, !dbg !2714           ; [#uses=1 type=i32] [debug line = 82:4]
  br label %.preheader2, !dbg !2723               ; [debug line = 46:21]

.preheader2:                                      ; preds = %15, %.preheader2.preheader
  %o_d = phi i32 [ %o_d.1, %15 ], [ 0, %.preheader2.preheader ] ; [#uses=5 type=i32]
  %tmp.7 = icmp slt i32 %o_d, %od, !dbg !2723     ; [#uses=1 type=i1] [debug line = 46:21]
  br i1 %tmp.7, label %.preheader1.preheader, label %16, !dbg !2723 ; [debug line = 46:21]

.preheader1.preheader:                            ; preds = %.preheader2
  %tmp.8 = add i32 %num_weights, %tmp.2, !dbg !2705 ; [#uses=1 type=i32] [debug line = 55:86]
  %tmp.9 = add i32 %tmp.8, %o_d, !dbg !2705       ; [#uses=1 type=i32] [debug line = 55:86]
  %mem.addr = getelementptr inbounds float* %mem, i32 %tmp.9, !dbg !2705 ; [#uses=1 type=float*] [debug line = 55:86]
  %tmp.10 = mul i32 %o_d, %id, !dbg !2724         ; [#uses=1 type=i32] [debug line = 71:113]
  %tmp12 = add i32 %o_d, %tmp.6                   ; [#uses=1 type=i32]
  %tmp14 = mul i32 %tmp12, %oy                    ; [#uses=1 type=i32]
  br label %.preheader1, !dbg !2726               ; [debug line = 49:23]

.preheader1:                                      ; preds = %14, %.preheader1.preheader
  %o_y = phi i32 [ %o_y.1, %14 ], [ 0, %.preheader1.preheader ] ; [#uses=4 type=i32]
  %tmp.16 = icmp slt i32 %o_y, %oy, !dbg !2726    ; [#uses=1 type=i1] [debug line = 49:23]
  br i1 %tmp.16, label %.preheader.preheader, label %15, !dbg !2726 ; [debug line = 49:23]

.preheader.preheader:                             ; preds = %.preheader1
  %i_y = mul nsw i32 %o_y, %s, !dbg !2727         ; [#uses=2 type=i32] [debug line = 63:42]
  %tmp.18 = add nsw i32 %i_y, %k, !dbg !2727      ; [#uses=1 type=i32] [debug line = 63:42]
  %tmp13 = add i32 %o_y, %tmp14                   ; [#uses=1 type=i32]
  %tmp16 = mul i32 %tmp13, %ox                    ; [#uses=1 type=i32]
  br label %.preheader, !dbg !2728                ; [debug line = 52:25]

.preheader:                                       ; preds = %13, %.preheader.preheader
  %o_x = phi i32 [ %o_x.1, %13 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i32]
  %tmp.20 = icmp slt i32 %o_x, %ox, !dbg !2728    ; [#uses=1 type=i1] [debug line = 52:25]
  br i1 %tmp.20, label %2, label %14, !dbg !2728  ; [debug line = 52:25]

; <label>:2                                       ; preds = %.preheader
  %output_element = load float* %mem.addr, align 4, !dbg !2705 ; [#uses=2 type=float] [debug line = 55:86]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %output_element) nounwind
  call void @llvm.dbg.value(metadata !{float %output_element}, i64 0, metadata !2729), !dbg !2705 ; [debug line = 55:86] [debug variable = output_element]
  %i_x = mul nsw i32 %o_x, %s, !dbg !2730         ; [#uses=2 type=i32] [debug line = 66:44]
  %tmp.22 = add nsw i32 %i_x, %k, !dbg !2730      ; [#uses=1 type=i32] [debug line = 66:44]
  br label %3, !dbg !2731                         ; [debug line = 60:27]

; <label>:3                                       ; preds = %12, %2
  %output_element1 = phi float [ %output_element, %2 ], [ %output_element.1.lcssa, %12 ] ; [#uses=2 type=float]
  %i_d = phi i32 [ 0, %2 ], [ %i_d.1, %12 ]       ; [#uses=4 type=i32]
  %tmp.24 = icmp slt i32 %i_d, %id, !dbg !2731    ; [#uses=1 type=i1] [debug line = 60:27]
  br i1 %tmp.24, label %4, label %13, !dbg !2731  ; [debug line = 60:27]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i32 %i_y}, i64 0, metadata !2732), !dbg !2727 ; [debug line = 63:42] [debug variable = i_y]
  %tmp4 = add i32 %i_d, %tmp.5                    ; [#uses=1 type=i32]
  %tmp5 = mul i32 %tmp4, %iy                      ; [#uses=1 type=i32]
  %tmp9 = add i32 %i_d, %tmp.10                   ; [#uses=1 type=i32]
  %tmp10 = mul i32 %tmp9, %k                      ; [#uses=1 type=i32]
  br label %5, !dbg !2727                         ; [debug line = 63:42]

; <label>:5                                       ; preds = %11, %4
  %output_element.1 = phi float [ %output_element1, %4 ], [ %output_element.2.lcssa, %11 ] ; [#uses=2 type=float]
  %i_y1 = phi i32 [ %i_y, %4 ], [ %i_y.2, %11 ]   ; [#uses=3 type=i32]
  %iiy = phi i32 [ 0, %4 ], [ %iiy.1, %11 ]       ; [#uses=2 type=i32]
  %tmp.28 = icmp slt i32 %i_y1, %tmp.18, !dbg !2727 ; [#uses=1 type=i1] [debug line = 63:42]
  br i1 %tmp.28, label %6, label %12, !dbg !2727  ; [debug line = 63:42]

; <label>:6                                       ; preds = %5
  call void @llvm.dbg.value(metadata !{i32 %i_x}, i64 0, metadata !2733), !dbg !2730 ; [debug line = 66:44] [debug variable = i_x]
  ...
  br label %7, !dbg !2730                         ; [debug line = 66:44]

; <label>:7                                       ; preds = %._crit_edge, %6
  %output_element.2 = phi float [ %output_element.1, %6 ], [ %output_element.4, %._crit_edge ] ; [#uses=4 type=float]
  %i_x1 = phi i32 [ %i_x, %6 ], [ %i_x.2, %._crit_edge ] ; [#uses=3 type=i32]
  %iix = phi i32 [ 0, %6 ], [ %iix.1, %._crit_edge ] ; [#uses=2 type=i32]
  %tmp.30 = icmp slt i32 %i_x1, %tmp.22, !dbg !2730 ; [#uses=1 type=i1] [debug line = 66:44]
  br i1 %tmp.30, label %8, label %11, !dbg !2730  ; [debug line = 66:44]

; <label>:8                                       ; preds = %7
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !2734 ; [#uses=1 type=i32] [debug line = 67:16]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2735 ; [debug line = 68:1]
  %tmp.31 = add i32 %od, %tmp.2, !dbg !2716       ; [#uses=1 type=i32] [debug line = 69:120]
  %tmp.32 = add i32 %tmp.31, %num_weights, !dbg !2716 ; [#uses=1 type=i32] [debug line = 69:120]
  %tmp.33 = add i32 %tmp.32, %tmp6, !dbg !2716    ; [#uses=1 type=i32] [debug line = 69:120]
  %tmp.34 = add i32 %tmp.33, %i_x1, !dbg !2716    ; [#uses=1 type=i32] [debug line = 69:120]
  %mem.addr.2 = getelementptr inbounds float* %mem, i32 %tmp.34, !dbg !2716 ; [#uses=1 type=float*] [debug line = 69:120]
  %input_element = load float* %mem.addr.2, align 4, !dbg !2716 ; [#uses=3 type=float] [debug line = 69:120]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %input_element) nounwind
  call void @llvm.dbg.value(metadata !{float %input_element}, i64 0, metadata !2736), !dbg !2716 ; [debug line = 69:120] [debug variable = input_element]
  %tmp.35 = fcmp une float %input_element, 0.000000e+00, !dbg !2737 ; [#uses=1 type=i1] [debug line = 70:18]
  br i1 %tmp.35, label %9, label %._crit_edge, !dbg !2737 ; [debug line = 70:18]

; <label>:9                                       ; preds = %8
  %tmp.38 = add i32 %tmp11, %tmp.2, !dbg !2724    ; [#uses=1 type=i32] [debug line = 71:113]
  %tmp.39 = add i32 %tmp.38, %iix, !dbg !2724     ; [#uses=1 type=i32] [debug line = 71:113]
  %mem.addr.3 = getelementptr inbounds float* %mem, i32 %tmp.39, !dbg !2724 ; [#uses=1 type=float*] [debug line = 71:113]
  %weight_element = load float* %mem.addr.3, align 4, !dbg !2724 ; [#uses=3 type=float] [debug line = 71:113]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %weight_element) nounwind
  call void @llvm.dbg.value(metadata !{float %weight_element}, i64 0, metadata !2738), !dbg !2724 ; [debug line = 71:113] [debug variable = weight_element]
  %tmp.40 = fcmp une float %weight_element, 0.000000e+00, !dbg !2739 ; [#uses=1 type=i1] [debug line = 72:22]
  br i1 %tmp.40, label %10, label %._crit_edge, !dbg !2739 ; [debug line = 72:22]

; <label>:10                                      ; preds = %9
  %tmp.41 = fmul float %input_element, %weight_element, !dbg !2740 ; [#uses=1 type=float] [debug line = 73:23]
  %output_element.3 = fadd float %output_element.2, %tmp.41, !dbg !2740 ; [#uses=1 type=float] [debug line = 73:23]
  call void @llvm.dbg.value(metadata !{float %output_element.3}, i64 0, metadata !2729), !dbg !2740 ; [debug line = 73:23] [debug variable = output_element]
  br label %._crit_edge, !dbg !2742               ; [debug line = 74:22]
...
._crit_edge:                                      ; preds = %10, %9, %8
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !2743 ; [#uses=0 type=i32] [debug line = 78:15]
  %i_x.2 = add nsw i32 %i_x1, 1, !dbg !2744       ; [#uses=1 type=i32] [debug line = 66:61]
  call void @llvm.dbg.value(metadata !{i32 %i_x.2}, i64 0, metadata !2733), !dbg !2744 ; [debug line = 66:61] [debug variable = i_x]
  %iix.1 = add nsw i32 %iix, 1, !dbg !2744        ; [#uses=1 type=i32] [debug line = 66:61]
  call void @llvm.dbg.value(metadata !{i32 %iix.1}, i64 0, metadata !2745), !dbg !2744 ; [debug line = 66:61] [debug variable = iix]
  br label %7, !dbg !2744                         ; [debug line = 66:61]

; <label>:11                                      ; preds = %7
  %output_element.2.lcssa = phi float [ %output_element.2, %7 ] ; [#uses=1 type=float]
  %i_y.2 = add nsw i32 %i_y1, 1, !dbg !2746       ; [#uses=1 type=i32] [debug line = 63:59]
  call void @llvm.dbg.value(metadata !{i32 %i_y.2}, i64 0, metadata !2732), !dbg !2746 ; [debug line = 63:59] [debug variable = i_y]
  %iiy.1 = add nsw i32 %iiy, 1, !dbg !2746        ; [#uses=1 type=i32] [debug line = 63:59]
  call void @llvm.dbg.value(metadata !{i32 %iiy.1}, i64 0, metadata !2747), !dbg !2746 ; [debug line = 63:59] [debug variable = iiy]
  br label %5, !dbg !2746                         ; [debug line = 63:59]

; <label>:12                                      ; preds = %5
  %output_element.1.lcssa = phi float [ %output_element.1, %5 ] ; [#uses=1 type=float]
  %i_d.1 = add nsw i32 %i_d, 1, !dbg !2748        ; [#uses=1 type=i32] [debug line = 60:39]
  call void @llvm.dbg.value(metadata !{i32 %i_d.1}, i64 0, metadata !2749), !dbg !2748 ; [debug line = 60:39] [debug variable = i_d]
  br label %3, !dbg !2748                         ; [debug line = 60:39]

; <label>:13                                      ; preds = %3
  %output_element.0.lcssa = phi float [ %output_element1, %3 ] ; [#uses=1 type=float]
  %tmp.25 = add i32 %tmp16, %tmp.3, !dbg !2714    ; [#uses=1 type=i32] [debug line = 82:4]
  %tmp.26 = add i32 %tmp.25, %o_x, !dbg !2714     ; [#uses=1 type=i32] [debug line = 82:4]
  %mem.addr.1 = getelementptr inbounds float* %mem, i32 %tmp.26, !dbg !2714 ; [#uses=1 type=float*] [debug line = 82:4]
  store float %output_element.0.lcssa, float* %mem.addr.1, align 4, !dbg !2714 ; [debug line = 82:4]
  %o_x.1 = add nsw i32 %o_x, 1, !dbg !2750        ; [#uses=1 type=i32] [debug line = 52:37]
  call void @llvm.dbg.value(metadata !{i32 %o_x.1}, i64 0, metadata !2751), !dbg !2750 ; [debug line = 52:37] [debug variable = o_x]
  br label %.preheader, !dbg !2750                ; [debug line = 52:37]

; <label>:14                                      ; preds = %.preheader
  %o_y.1 = add nsw i32 %o_y, 1, !dbg !2752        ; [#uses=1 type=i32] [debug line = 49:35]
  call void @llvm.dbg.value(metadata !{i32 %o_y.1}, i64 0, metadata !2753), !dbg !2752 ; [debug line = 49:35] [debug variable = o_y]
  br label %.preheader1, !dbg !2752               ; [debug line = 49:35]

; <label>:15                                      ; preds = %.preheader1
  %o_d.1 = add nsw i32 %o_d, 1, !dbg !2754        ; [#uses=1 type=i32] [debug line = 46:33]
  call void @llvm.dbg.value(metadata !{i32 %o_d.1}, i64 0, metadata !2755), !dbg !2754 ; [debug line = 46:33] [debug variable = o_d]
  br label %.preheader2, !dbg !2754               ; [debug line = 46:33]

; <label>:16                                      ; preds = %.preheader2
  %b_.1 = add nsw i32 %b_, 1, !dbg !2756          ; [#uses=1 type=i32] [debug line = 43:25]
  call void @llvm.dbg.value(metadata !{i32 %b_.1}, i64 0, metadata !2757), !dbg !2756 ; [debug line = 43:25] [debug variable = b_]
  br label %1, !dbg !2756                         ; [debug line = 43:25]

; <label>:17                                      ; preds = %1
  ret void, !dbg !2758                            ; [debug line = 87:1]
}
...
!2701 = metadata !{i32 37, i32 29, metadata !2688, null}
!2702 = metadata !{i32 786688, metadata !2688, metadata !"num_weights", metadata !869, i32 37, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2703 = metadata !{i32 786688, metadata !2688, metadata !"num_biases", metadata !869, i32 38, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2704 = metadata !{i32 38, i32 22, metadata !2688, null}
!2705 = metadata !{i32 55, i32 86, metadata !2706, null}
!2706 = metadata !{i32 786443, metadata !2707, i32 53, i32 9, metadata !869, i32 8} ; [ DW_TAG_lexical_block ]
!2707 = metadata !{i32 786443, metadata !2708, i32 52, i32 9, metadata !869, i32 7} ; [ DW_TAG_lexical_block ]
!2708 = metadata !{i32 786443, metadata !2709, i32 50, i32 7, metadata !869, i32 6} ; [ DW_TAG_lexical_block ]
!2709 = metadata !{i32 786443, metadata !2710, i32 49, i32 7, metadata !869, i32 5} ; [ DW_TAG_lexical_block ]
!2710 = metadata !{i32 786443, metadata !2711, i32 47, i32 5, metadata !869, i32 4} ; [ DW_TAG_lexical_block ]
!2711 = metadata !{i32 786443, metadata !2712, i32 46, i32 5, metadata !869, i32 3} ; [ DW_TAG_lexical_block ]
!2712 = metadata !{i32 786443, metadata !2713, i32 44, i32 3, metadata !869, i32 2} ; [ DW_TAG_lexical_block ]
!2713 = metadata !{i32 786443, metadata !2688, i32 43, i32 3, metadata !869, i32 1} ; [ DW_TAG_lexical_block ]
!2714 = metadata !{i32 82, i32 4, metadata !2706, null}
!2715 = metadata !{i32 43, i32 16, metadata !2713, null}
!2716 = metadata !{i32 69, i32 120, metadata !2717, null}
!2717 = metadata !{i32 786443, metadata !2718, i32 67, i32 15, metadata !869, i32 14} ; [ DW_TAG_lexical_block ]
!2718 = metadata !{i32 786443, metadata !2719, i32 66, i32 15, metadata !869, i32 13} ; [ DW_TAG_lexical_block ]
!2719 = metadata !{i32 786443, metadata !2720, i32 64, i32 13, metadata !869, i32 12} ; [ DW_TAG_lexical_block ]
!2720 = metadata !{i32 786443, metadata !2721, i32 63, i32 13, metadata !869, i32 11} ; [ DW_TAG_lexical_block ]
!2721 = metadata !{i32 786443, metadata !2722, i32 61, i32 11, metadata !869, i32 10} ; [ DW_TAG_lexical_block ]
!2722 = metadata !{i32 786443, metadata !2706, i32 60, i32 11, metadata !869, i32 9} ; [ DW_TAG_lexical_block ]
!2723 = metadata !{i32 46, i32 21, metadata !2711, null}
!2724 = metadata !{i32 71, i32 113, metadata !2725, null}
!2725 = metadata !{i32 786443, metadata !2717, i32 70, i32 44, metadata !869, i32 15} ; [ DW_TAG_lexical_block ]
!2726 = metadata !{i32 49, i32 23, metadata !2709, null}
!2727 = metadata !{i32 63, i32 42, metadata !2720, null}
!2728 = metadata !{i32 52, i32 25, metadata !2707, null}
!2729 = metadata !{i32 786688, metadata !2706, metadata !"output_element", metadata !869, i32 55, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2730 = metadata !{i32 66, i32 44, metadata !2718, null}
!2731 = metadata !{i32 60, i32 27, metadata !2722, null}
!2732 = metadata !{i32 786688, metadata !2720, metadata !"i_y", metadata !869, i32 63, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2733 = metadata !{i32 786688, metadata !2718, metadata !"i_x", metadata !869, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2734 = metadata !{i32 67, i32 16, metadata !2717, null}
!2735 = metadata !{i32 68, i32 1, metadata !2717, null}
!2736 = metadata !{i32 786688, metadata !2717, metadata !"input_element", metadata !869, i32 69, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2737 = metadata !{i32 70, i32 18, metadata !2717, null}
!2738 = metadata !{i32 786688, metadata !2725, metadata !"weight_element", metadata !869, i32 71, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2739 = metadata !{i32 72, i32 22, metadata !2725, null}
!2740 = metadata !{i32 73, i32 23, metadata !2741, null}
!2741 = metadata !{i32 786443, metadata !2725, i32 72, i32 49, metadata !869, i32 16} ; [ DW_TAG_lexical_block ]
!2742 = metadata !{i32 74, i32 22, metadata !2741, null}
!2743 = metadata !{i32 78, i32 15, metadata !2717, null}
!2744 = metadata !{i32 66, i32 61, metadata !2718, null}
!2745 = metadata !{i32 786688, metadata !2718, metadata !"iix", metadata !869, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2746 = metadata !{i32 63, i32 59, metadata !2720, null}
!2747 = metadata !{i32 786688, metadata !2720, metadata !"iiy", metadata !869, i32 63, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2748 = metadata !{i32 60, i32 39, metadata !2722, null}
!2749 = metadata !{i32 786688, metadata !2722, metadata !"i_d", metadata !869, i32 60, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2750 = metadata !{i32 52, i32 37, metadata !2707, null}
!2751 = metadata !{i32 786688, metadata !2707, metadata !"o_x", metadata !869, i32 52, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2752 = metadata !{i32 49, i32 35, metadata !2709, null}
!2753 = metadata !{i32 786688, metadata !2709, metadata !"o_y", metadata !869, i32 49, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2754 = metadata !{i32 46, i32 33, metadata !2711, null}
!2755 = metadata !{i32 786688, metadata !2711, metadata !"o_d", metadata !869, i32 46, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2756 = metadata !{i32 43, i32 25, metadata !2713, null}
!2757 = metadata !{i32 786688, metadata !2713, metadata !"b_", metadata !869, i32 43, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2758 = metadata !{i32 87, i32 1, metadata !2688, null}
