...
; <label>:1                                       ; preds = %14, %0
  %b_ = phi i31 [ 0, %0 ], [ %b_.1, %14 ]         ; [#uses=2 type=i31]
  ...
  br i1 %tmp.4, label %.preheader2.preheader, label %15, !dbg !2772 ; [debug line = 43:16]
...
.preheader2:                                      ; preds = %13, %.preheader2.preheader
  %o_d = phi i31 [ %o_d.1, %13 ], [ 0, %.preheader2.preheader ] ; [#uses=2 type=i31]
  ...
  br i1 %tmp.7, label %.preheader1.preheader, label %14, !dbg !2780 ; [debug line = 46:21]
...
.preheader1.preheader:                            ; preds = %.preheader2
  ...
  br label %.preheader1, !dbg !2782               ; [debug line = 49:23]

.preheader1:                                      ; preds = %12, %.preheader1.preheader
  %o_y = phi i31 [ %o_y.1, %12 ], [ 0, %.preheader1.preheader ] ; [#uses=2 type=i31]
  %o_y.cast = zext i31 %o_y to i32, !dbg !2782    ; [#uses=3 type=i32] [debug line = 49:23]
  %tmp.1 = icmp slt i32 %o_y.cast, %oy, !dbg !2782 ; [#uses=1 type=i1] [debug line = 49:23]
  br i1 %tmp.1, label %.preheader.preheader, label %13, !dbg !2782 ; [debug line = 49:23]

.preheader.preheader:                             ; preds = %.preheader1
  %i_y = mul nsw i32 %o_y.cast, %s, !dbg !2783    ; [#uses=2 type=i32] [debug line = 63:42]
  %tmp.8 = add nsw i32 %i_y, %k, !dbg !2783       ; [#uses=1 type=i32] [debug line = 63:42]
  %tmp7 = add i32 %tmp2, %o_y.cast                ; [#uses=1 type=i32]
  %tmp12 = mul i32 %tmp7, %ox                     ; [#uses=1 type=i32]
  br label %.preheader, !dbg !2784                ; [debug line = 52:25]

.preheader:                                       ; preds = %11, %.preheader.preheader
  %o_x = phi i31 [ %o_x.1, %11 ], [ 0, %.preheader.preheader ] ; [#uses=2 type=i31]
  %o_x.cast = zext i31 %o_x to i32, !dbg !2784    ; [#uses=3 type=i32] [debug line = 52:25]
  %tmp.10 = icmp slt i32 %o_x.cast, %ox, !dbg !2784 ; [#uses=1 type=i1] [debug line = 52:25]
  br i1 %tmp.10, label %2, label %12, !dbg !2784  ; [debug line = 52:25]

; <label>:2                                       ; preds = %.preheader
  %output_element = load float* %mem.addr, align 4, !dbg !2762 ; [#uses=1 type=float] [debug line = 55:86]
  call void @llvm.dbg.value(metadata !{float %output_element}, i64 0, metadata !2785), !dbg !2762 ; [debug line = 55:86] [debug variable = output_element]
  %i_x = mul nsw i32 %o_x.cast, %s, !dbg !2786    ; [#uses=2 type=i32] [debug line = 66:44]
  %tmp.11 = add nsw i32 %i_x, %k, !dbg !2786      ; [#uses=1 type=i32] [debug line = 66:44]
  br label %3, !dbg !2787                         ; [debug line = 60:27]

; <label>:3                                       ; preds = %10, %2
  %output_element1 = phi float [ %output_element, %2 ], [ %output_element.1.lcssa, %10 ] ; [#uses=2 type=float]
  %i_d = phi i31 [ 0, %2 ], [ %i_d.1, %10 ]       ; [#uses=2 type=i31]
  %i_d.cast = zext i31 %i_d to i32, !dbg !2787    ; [#uses=3 type=i32] [debug line = 60:27]
  %tmp.12 = icmp slt i32 %i_d.cast, %id, !dbg !2787 ; [#uses=1 type=i1] [debug line = 60:27]
  br i1 %tmp.12, label %4, label %11, !dbg !2787  ; [debug line = 60:27]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i32 %i_y}, i64 0, metadata !2788), !dbg !2783 ; [debug line = 63:42] [debug variable = i_y]
  ...
  br label %5, !dbg !2783                         ; [debug line = 63:42]

; <label>:5                                       ; preds = %9, %4
  %output_element.1 = phi float [ %output_element1, %4 ], [ %output_element.2.lcssa, %9 ] ; [#uses=2 type=float]
  %i_y1 = phi i32 [ %i_y, %4 ], [ %i_y.1, %9 ]    ; [#uses=3 type=i32]
  %iiy = phi i32 [ 0, %4 ], [ %iiy.1, %9 ]        ; [#uses=2 type=i32]
  %tmp.14 = icmp slt i32 %i_y1, %tmp.8, !dbg !2783 ; [#uses=1 type=i1] [debug line = 63:42]
  br i1 %tmp.14, label %6, label %10, !dbg !2783  ; [debug line = 63:42]

; <label>:6                                       ; preds = %5
  call void @llvm.dbg.value(metadata !{i32 %i_x}, i64 0, metadata !2789), !dbg !2786 ; [debug line = 66:44] [debug variable = i_x]
  ...
  br label %7, !dbg !2786                         ; [debug line = 66:44]

; <label>:7                                       ; preds = %8, %6
  %output_element.2 = phi float [ %output_element.1, %6 ], [ %output_element.3, %8 ] ; [#uses=2 type=float]
  %i_x1 = phi i32 [ %i_x, %6 ], [ %i_x.1, %8 ]    ; [#uses=3 type=i32]
  %iix = phi i32 [ 0, %6 ], [ %iix.1, %8 ]        ; [#uses=2 type=i32]
  %tmp.15 = icmp slt i32 %i_x1, %tmp.11, !dbg !2786 ; [#uses=1 type=i1] [debug line = 66:44]
  br i1 %tmp.15, label %8, label %9, !dbg !2786   ; [debug line = 66:44]
...
; <label>:8                                       ; preds = %7
  ...
  %input_element = load float* %mem.addr.2, align 4, !dbg !2773 ; [#uses=1 type=float] [debug line = 69:135]
  call void @llvm.dbg.value(metadata !{float %input_element}, i64 0, metadata !2790), !dbg !2773 ; [debug line = 69:135] [debug variable = input_element]
  %tmp19 = add i32 %iix, %tmp.2, !dbg !2781       ; [#uses=1 type=i32] [debug line = 71:113]
  %tmp.17 = add i32 %tmp11, %tmp19, !dbg !2781    ; [#uses=1 type=i32] [debug line = 71:113]
  %mem.addr.3 = getelementptr inbounds float* %mem, i32 %tmp.17, !dbg !2781 ; [#uses=1 type=float*] [debug line = 71:113]
  %weight_element = load float* %mem.addr.3, align 4, !dbg !2781 ; [#uses=1 type=float] [debug line = 71:113]
  call void @llvm.dbg.value(metadata !{float %weight_element}, i64 0, metadata !2791), !dbg !2781 ; [debug line = 71:113] [debug variable = weight_element]
  %tmp.18 = fmul float %input_element, %weight_element, !dbg !2792 ; [#uses=1 type=float] [debug line = 73:23]
  %output_element.3 = fadd float %output_element.2, %tmp.18, !dbg !2792 ; [#uses=1 type=float] [debug line = 73:23]
  call void @llvm.dbg.value(metadata !{float %output_element.3}, i64 0, metadata !2785), !dbg !2792 ; [debug line = 73:23] [debug variable = output_element]
  %i_x.1 = add nsw i32 %i_x1, 1, !dbg !2793       ; [#uses=1 type=i32] [debug line = 66:61]
  call void @llvm.dbg.value(metadata !{i32 %i_x.1}, i64 0, metadata !2789), !dbg !2793 ; [debug line = 66:61] [debug variable = i_x]
  %iix.1 = add nsw i32 %iix, 1, !dbg !2793        ; [#uses=1 type=i32] [debug line = 66:61]
  call void @llvm.dbg.value(metadata !{i32 %iix.1}, i64 0, metadata !2794), !dbg !2793 ; [debug line = 66:61] [debug variable = iix]
  br label %7, !dbg !2793                         ; [debug line = 66:61]

; <label>:9                                       ; preds = %7
  %output_element.2.lcssa = phi float [ %output_element.2, %7 ] ; [#uses=1 type=float]
  %i_y.1 = add nsw i32 %i_y1, 1, !dbg !2795       ; [#uses=1 type=i32] [debug line = 63:59]
  call void @llvm.dbg.value(metadata !{i32 %i_y.1}, i64 0, metadata !2788), !dbg !2795 ; [debug line = 63:59] [debug variable = i_y]
  %iiy.1 = add nsw i32 %iiy, 1, !dbg !2795        ; [#uses=1 type=i32] [debug line = 63:59]
  call void @llvm.dbg.value(metadata !{i32 %iiy.1}, i64 0, metadata !2796), !dbg !2795 ; [debug line = 63:59] [debug variable = iiy]
  br label %5, !dbg !2795                         ; [debug line = 63:59]

; <label>:10                                      ; preds = %5
  %output_element.1.lcssa = phi float [ %output_element.1, %5 ] ; [#uses=1 type=float]
  %i_d.1 = add i31 %i_d, 1, !dbg !2797            ; [#uses=1 type=i31] [debug line = 60:39]
  call void @llvm.dbg.value(metadata !{i31 %i_d.1}, i64 0, metadata !2798), !dbg !2797 ; [debug line = 60:39] [debug variable = i_d]
  br label %3, !dbg !2797                         ; [debug line = 60:39]
...
; <label>:11                                      ; preds = %3
  ...
  %o_x.1 = add i31 %o_x, 1, !dbg !2799            ; [#uses=1 type=i31] [debug line = 52:37]
  call void @llvm.dbg.value(metadata !{i31 %o_x.1}, i64 0, metadata !2800), !dbg !2799 ; [debug line = 52:37] [debug variable = o_x]
  br label %.preheader, !dbg !2799                ; [debug line = 52:37]

; <label>:12                                      ; preds = %.preheader
  %o_y.1 = add i31 %o_y, 1, !dbg !2801            ; [#uses=1 type=i31] [debug line = 49:35]
  call void @llvm.dbg.value(metadata !{i31 %o_y.1}, i64 0, metadata !2802), !dbg !2801 ; [debug line = 49:35] [debug variable = o_y]
  br label %.preheader1, !dbg !2801               ; [debug line = 49:35]

; <label>:13                                      ; preds = %.preheader1
  %o_d.1 = add i31 %o_d, 1, !dbg !2803            ; [#uses=1 type=i31] [debug line = 46:33]
  call void @llvm.dbg.value(metadata !{i31 %o_d.1}, i64 0, metadata !2804), !dbg !2803 ; [debug line = 46:33] [debug variable = o_d]
  br label %.preheader2, !dbg !2803               ; [debug line = 46:33]

; <label>:14                                      ; preds = %.preheader2
  %b_.1 = add i31 %b_, 1, !dbg !2805              ; [#uses=1 type=i31] [debug line = 43:25]
  call void @llvm.dbg.value(metadata !{i31 %b_.1}, i64 0, metadata !2806), !dbg !2805 ; [debug line = 43:25] [debug variable = b_]
  br label %1, !dbg !2805                         ; [debug line = 43:25]

; <label>:15                                      ; preds = %1
  ret void, !dbg !2807                            ; [debug line = 87:1]
}
...
!2781 = metadata !{i32 71, i32 113, metadata !2774, null}
!2782 = metadata !{i32 49, i32 23, metadata !2766, null}
!2783 = metadata !{i32 63, i32 42, metadata !2777, null}
!2784 = metadata !{i32 52, i32 25, metadata !2764, null}
!2785 = metadata !{i32 786688, metadata !2763, metadata !"output_element", metadata !869, i32 55, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2786 = metadata !{i32 66, i32 44, metadata !2775, null}
!2787 = metadata !{i32 60, i32 27, metadata !2779, null}
!2788 = metadata !{i32 786688, metadata !2777, metadata !"i_y", metadata !869, i32 63, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2789 = metadata !{i32 786688, metadata !2775, metadata !"i_x", metadata !869, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2790 = metadata !{i32 786688, metadata !2774, metadata !"input_element", metadata !869, i32 69, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2791 = metadata !{i32 786688, metadata !2774, metadata !"weight_element", metadata !869, i32 71, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2792 = metadata !{i32 73, i32 23, metadata !2774, null}
!2793 = metadata !{i32 66, i32 61, metadata !2775, null}
!2794 = metadata !{i32 786688, metadata !2775, metadata !"iix", metadata !869, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2795 = metadata !{i32 63, i32 59, metadata !2777, null}
!2796 = metadata !{i32 786688, metadata !2777, metadata !"iiy", metadata !869, i32 63, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2797 = metadata !{i32 60, i32 39, metadata !2779, null}
!2798 = metadata !{i32 786688, metadata !2779, metadata !"i_d", metadata !869, i32 60, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2799 = metadata !{i32 52, i32 37, metadata !2764, null}
!2800 = metadata !{i32 786688, metadata !2764, metadata !"o_x", metadata !869, i32 52, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2801 = metadata !{i32 49, i32 35, metadata !2766, null}
!2802 = metadata !{i32 786688, metadata !2766, metadata !"o_y", metadata !869, i32 49, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2803 = metadata !{i32 46, i32 33, metadata !2768, null}
!2804 = metadata !{i32 786688, metadata !2768, metadata !"o_d", metadata !869, i32 46, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2805 = metadata !{i32 43, i32 25, metadata !2770, null}
!2806 = metadata !{i32 786688, metadata !2770, metadata !"b_", metadata !869, i32 43, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2807 = metadata !{i32 87, i32 1, metadata !2745, null}
