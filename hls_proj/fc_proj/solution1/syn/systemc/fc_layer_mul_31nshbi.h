...
#ifndef __fc_layer_mul_31nshbi__HH__
#define __fc_layer_mul_31nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fc_layer_mul_31nshbi) {
    ...
    SC_CTOR(fc_layer_mul_31nshbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
