...
entity fc_layer_CTRL_BUS_s_axi is
generic (
...
end entity fc_layer_CTRL_BUS_s_axi;
...
architecture behave of fc_layer_CTRL_BUS_s_axi is
    ...
    constant ADDR_NUM_INPUTS_DATA_0    : INTEGER := 16#28#;
    constant ADDR_NUM_INPUTS_CTRL      : INTEGER := 16#2c#;
    constant ADDR_NUM_OUTPUTS_DATA_0   : INTEGER := 16#30#;
    constant ADDR_NUM_OUTPUTS_CTRL     : INTEGER := 16#34#;
    constant ADDR_ENABLE_RELU_DATA_0   : INTEGER := 16#38#;
    constant ADDR_ENABLE_RELU_CTRL     : INTEGER := 16#3c#;
    ...
    signal int_num_inputs      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_num_outputs     : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_NUM_INPUTS_DATA_0 =>
                        rdata_data <= RESIZE(int_num_inputs(31 downto 0), 32);
                    when ADDR_NUM_OUTPUTS_DATA_0 =>
                        rdata_data <= RESIZE(int_num_outputs(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    num_inputs           <= STD_LOGIC_VECTOR(int_num_inputs);
    num_outputs          <= STD_LOGIC_VECTOR(int_num_outputs);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NUM_INPUTS_DATA_0) then
                    int_num_inputs(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_num_inputs(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NUM_OUTPUTS_DATA_0) then
                    int_num_outputs(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_num_outputs(31 downto 0));
                end if;
            end if;
        end if;
    end process;
