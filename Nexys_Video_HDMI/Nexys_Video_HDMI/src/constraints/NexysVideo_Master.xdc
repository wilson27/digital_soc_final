...
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led_8bits_tri_io[0]}]
