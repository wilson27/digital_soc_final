...
typedef struct {
    ...
    XFc_layer_uio_map maps[ MAX_UIO_MAPS ];
} XFc_layer_uio_info;

/***************** Variable Definitions **************************************/
static XFc_layer_uio_info uio_info;
...
static int uio_info_read_name(XFc_layer_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XFc_layer_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XFc_layer_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XFc_layer_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XFc_layer_Initialize(XFc_layer *InstancePtr, const char* InstanceName) {
	XFc_layer_uio_info *InfoPtr = &uio_info;
